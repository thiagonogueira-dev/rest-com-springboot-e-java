...
import br.com.spring.data.vo.v1.UploadFileResponseVO;
import br.com.spring.services.FileStorageService;
...
public class FileController {
	...
	public UploadFileResponseVO uploadFile(
		...
		logger.info("Salvando um arquivo em disco!");
	...
	public List<UploadFileResponseVO> uploadMultipleFiles(
		...
		logger.info("Salvando vários arquivos em disco!");
